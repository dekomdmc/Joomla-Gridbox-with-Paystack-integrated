...
<form autocomplete="off" action="<?php echo JRoute::_('index.php?option=com_gridbox&view=paymentmethods'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row-fluid">
                ...
                <div class="ba-main-view">
                    <div id="filter-bar">
                        ...
                        <div class="filter-search-wrapper">
                            <div>
                                <input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" placeholder="<?php echo JText::_('JSEARCH_FILTER') ?>">
                        ...
                        <div class="twin-view-right-sidebar">
                            ...
                            <div class="twin-view-sidebar-body">
                                ...
                                <div class="ba-options-group-wrapper">
                                    ...
                                    <div class="paystack-payment-options">
                                        <div class="ba-options-group-element">
                                            <label class="ba-options-group-label">API Key</label>
                                            <input type="text" data-settings="api_key">
                                        </div>
                ...
                <div id="gridbox-payment-methods-dialog" class="ba-modal-lg modal hide" style="display: none;">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="ba-group-wrapper gridbox-apps-wrapper">
                            ...
                            ?>
                                <div class="gridbox-app-element" data-type="<?php echo $key; ?>" data-installed="<?php echo (int)$method->installed; ?>">
